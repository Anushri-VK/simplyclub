...
from club.models import Complete,BlogArticle
...
def blog_articles(request,id):
	blog_instance=Complete.objects.get(pk=id)
	all_4=BlogArticle.objects.filter(blogs=blog_instance)
